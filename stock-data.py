...
def plot_stock(stock_symbol):
    ...
    ax[0].set_title(f'Stock Price and Peaks for {stock_symbol}')
    ...
    ax[1].set_title(f'Fibonacci Retracement and Extensions for {stock_symbol}')
    ...
    ax[2].set_title(f'Trend Lines and Channels for {stock_symbol}')
